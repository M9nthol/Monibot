...
def handle_callback_query_weapon_veteran_weapon(call):
    ...
    button_back = types.InlineKeyboardButton(text="Назад⬇️", callback_data="back")
    markup.add(button_a16, button_a17, button_a18, button_a19, button_a20, button_a21, button_a22, button_a75, button_a76, button_a78, button_a77, button_back)
...
@bot.callback_query_handler(
    func=lambda call: call.data in ["a1", "a3", "a4", "a5", "a6", "a7", "a8", "a9", "a10", "a11", "a12", "a13", "a14",
                                    ...
                                    "a27", "a28", "a29", "a30", "a31", "a32", "a33", "a34", "a35", "a36", "a37", "a66", "a67", "a68", "a69", "a70", "a71", "a72", "a73", "a74", "a75", "a76", "a77", "a78", "a79", "a80"])
